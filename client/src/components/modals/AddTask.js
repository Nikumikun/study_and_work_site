        ...
        <Modal.Body>
            <Form>
                <Container>
                    ...
                    <div className="mt-3">
                        Не забудьте отправить выбранную сумму для заказа по данным реквизитам. <br/>
                        После отправки перевода отправьте на почту одному из администраторов с сообщением о задании и скриншотом об оплате задания. <br/>
                        Реквизиты: 40817810364008678050
                    </div>
